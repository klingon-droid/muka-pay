<template>
  <div class="flex justify-center items-center relative w-full">
    ...
    <main ref="content" :class="[expanded ? 'pointer-events-auto scale-100 opacity-100 delay-100 duration-300 z-[9999] bg-black' : 'pointer-events-none scale-[0.5] opacity-0 duration-200 ', 'transition-all  fixed h-screen w-screen top-0 left-0 ']">
